...
class _TagState extends State<Tag> {
  ...
  final Map<String, List<String>> groupedTags = {
    '趣味': ['音楽', '映画', 'ゲーム', 'スポーツ', '旅行', '読書',
      ...
      'キャンプ', '手芸', '陶芸', '盆栽'],
    'プログラミング言語': ['Python', 'JavaScript', 'Java', 'C++',
      'C#', 'Ruby', 'Swift', 'PHP', 'Kotlin', 'Go', 'TypeScript',
      'Rust', 'Dart', 'R', 'Perl', 'Scala', 'MATLAB', 'Haskell'],
    '好きな動物': ['犬', '猫', 'ウサギ', 'ハムスター', '鳥', 'カメ',
      '魚', '馬', 'イルカ', 'ライオン', '虎', 'パンダ', 'ゾウ', 'キツネ',
      'コアラ', 'リス', 'ヘビ', 'ペンギン', 'アルパカ', 'カピバラ',
      'モルモット', 'フクロウ', 'ヤギ', '羊'],
    'スポーツ': ['サッカー', '野球', 'バスケットボール', 'テニス',
      'バドミントン', '卓球', 'ゴルフ', 'バレーボール', 'ラグビー',
      'スキー', 'スノーボード', 'スケートボード', '陸上競技', '水泳',
      'ダイビング', 'サーフィン', '柔道', '剣道', '空手', 'ボクシング',
      'ムエタイ', '総合格闘技', 'エアロビクス', 'トランポリン', 'クリケット',
      'チェス', 'ボウリング', 'フットサル', 'ラクロス', 'カヌー',
      'エスクリマ', 'アーチェリー', '乗馬'],
    'お酒': ['ビール', 'ワイン', '日本酒', '焼酎', 'ウィスキー',
      'ジン', 'ウォッカ', '紹興酒', 'マッコリ', 'カクテル', '果実酒',
      '梅酒', 'スパークリングワイン', 'ハイボール', 'サワー'],
  };
